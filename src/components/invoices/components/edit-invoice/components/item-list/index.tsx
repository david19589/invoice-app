...
import { InvoiceItem } from "../../../../../utils/invoice-types";
import { useFormContext } from "react-hook-form";

function ItemList(props: { darkMode: boolean; selectedItem: InvoiceItem }) {
      ...
      <div className="md:flex md:items-center md:gap-[1rem] mb-[3rem]">
        <div className="md:mb-0 mb-[1rem]">
          ...
          <input
            ...
            type="text"
            id="item-name"
            placeholder={props.selectedItem.item_name}
            className={clsx(
          ...
          <div className="flex items-center gap-[1rem]">
            <div>
              ...
              <input
                ...
                type="text"
                id="quantity"
                placeholder={props.selectedItem.quantity.toString()}
                className={clsx(
            ...
            <div>
              ...
              <input
                ...
                type="text"
                id="price"
                placeholder={props.selectedItem.price.toString()}
                className={clsx(
