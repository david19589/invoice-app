    ...
    <div>
      ...
      <div className="mb-[1.5rem]">
        ...
        <input
          ...
          type="text"
          id="clients-name"
          placeholder={props.selectedInvoice.clients_name}
          className={clsx(
      ...
      <div className="mb-[1.5rem]">
        ...
        <input
          ...
          type="text"
          id="clients-email"
          placeholder={props.selectedInvoice.clients_email}
          className={clsx(
      ...
      <div className="mb-[1.5rem]">
        ...
        <input
          ...
          placeholder={props.selectedInvoice.clients_street_address}
          className={clsx(
      ...
      <div className="md:flex md:gap-[1.5rem]">
        <div className="flex justify-between items-center gap-[1.5rem]">
          <div className="mb-[1.5rem]">
            ...
            <input
              ...
              type="text"
              id="clients-city"
              placeholder={props.selectedInvoice.clients_city}
              className={clsx(
          ...
          <div className="mb-[1.5rem]">
            ...
            <input
              ...
              placeholder={props.selectedInvoice.clients_post_code}
              className={clsx(
        ...
        <div className="md:mb-0 mb-[2.5rem]">
          ...
          <input
            ...
            type="text"
            id="clients-country"
            placeholder={props.selectedInvoice.clients_country}
            className={clsx(
      ...
      <div className="mb-[4rem] relative">
        ...
        <div className="mb-[2.5rem]">
          ...
          <input
            ...
            placeholder={props.selectedInvoice.project_description}
            className={clsx(
